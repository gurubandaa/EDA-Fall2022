...
EPA2.select <- select(EPA1, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
#5. I used the mutate() function to fill all cells in AQS_PARAMETER_DESC with "PM2.5" in the PM2.5 datasets.
