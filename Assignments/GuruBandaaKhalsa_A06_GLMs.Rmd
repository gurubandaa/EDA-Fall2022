...
NTL1.wrangle.regression <- lm(data = NTL1.wrangle, depth ~ temperature_C)
...
> Answer: This means that we reject our alternative hypothesis and support our
          hypothesis that mean lake temperaturecrecorded during July has an
          effect on depth across all lakes.
          
          Again, the statistical significance of the result is represented by
          the p-value of less than 2.2e-16.
...
NTL1.wrangle.SOMEregression <- lm(data = NTL1.wrangle, temperature_C ~ depth + daynum)
summary(NTL1.wrangle.SOMEregression)
step(NTL1.wrangle.SOMEregression)

NTL1.wrangle.BESTregression <- lm(data = NTL1.wrangle, temperature_C ~ depth)
