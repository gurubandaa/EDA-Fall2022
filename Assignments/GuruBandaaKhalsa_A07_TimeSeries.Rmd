...
```{r}
#8. I used a linear interpolation to fill in missing daily data for ozone concentration
Ozone_Cnx = zoo::na.approx(Daily.Max.8.hour.Ozone.Concentration)

```

> Answer: We did not use a piecewise constant or spline interpolation because
            Ozone concentrations have changed over the 2010s at this station.
          They have gradually decreased.
