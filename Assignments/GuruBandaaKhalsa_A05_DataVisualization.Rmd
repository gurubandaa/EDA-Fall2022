...
```{r}
#1. I checked my working directory using the getwd() function, loaded the `tidyverse`, `lubridate`, and cowplot packages, and uploaded the NTL-LTER processed data files for nutrients and chemistry/physics for Peter and Paul Lakes.
getwd()
library(tidyverse)
library(lubridate)
library(cowplot)
