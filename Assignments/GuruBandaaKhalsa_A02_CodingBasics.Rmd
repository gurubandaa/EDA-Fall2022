...
```{r}
#5. I created three vectors titled "students," "scores," and "passing."
students <- c(Jimmy, Johnny, Timmy, Victor)
scores <- c(99, 76, 45, 95)
passing <- c(TRUE, TRUE, FALSE, TRUE)

#6. I labeled each vector with a comment on what type of vector it is.
is.vector(students)
