...
NTL.phys.data.1990thru1999 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 >= 1990 & year4 <= 1999)
NTL.phys.data.1990thru1999

# Exercise 2.2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999 using arrange.
NTL.phys.data.1990thru1999.2 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 %in% c(1990:1999))
NTL.phys.data.1990thru1999
```
Question: Why don't we filter using row numbers?

> Answer: Because we're filtering by columns, how the original dataset is set up.
