...
# The NC 8-Digit HUC dataset is a different coordinate system than the counties
# dataset.  The counties dataset is in North American Datum 1983.

colnames(counties_sf)

# The counties dataset has columns: "STATEFP"  "COUNTYFP" "COUNTYNS" "AFFGEOID"
# "GEOID"    "NAME"     "LSAD"     "ALAND"    "AWATER"   and "geometry".
...
counties_sf_join <- merge(x = huc8_sf,
                          y = wind_raw,
                          by.x = "HUC_8",
                          by.y = "HUC_8")
...
#View the outputs
mapView(counties_sf_join, zcol = "SumWindEnergy")
