...
#the_website <- read_html(paste0("https://www.eia.gov/electricity/state/archive"), the_year)
...
the_states_tag <- "td:nth-child(1)"
the_price_tag <- "td:nth-child(2)"
the_capacity_tag <- "td:nth-child(3)"
net_generation_tag <- "td:nth-child(4)"
total_retail_tag <- "td:nth-child(5)"
